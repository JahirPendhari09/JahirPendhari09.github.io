...
const Skills = () => {
  ...
  return (
    <div
    id="skills"
    style={{width:"90%",margin:"auto",marginBottom:"30px", userSelect: "none", WebkitUserSelect: "none" ,padding:"20px", borderRadius:"20px",marginTop:"-50px"}}
    >
      <h1
     ...
     >
      ...
      <div>
          <p 
          style={{fontSize:"25px",fontWeight:"bold",textShadow:"2px 2px 10px rgb(250 200 100)",borderRadius:"10px",width:"100px",margin:"auto",border:"1px solid black",cursor:"pointer",marginTop:"20px",marginBottom:"20px"}}
          >
            Skills
          </p>
        <div style={{ width:"90%", margin:"auto",display:"grid", gridTemplateColumns:"repeat(4,1fr)",gap:"60px",marginBottom:"50px"}}>
      ...
      <div>
        ...
        <div style={{ width:"90%", margin:"auto",display:"grid", gridTemplateColumns:"repeat(4,1fr)",gap:"60px"}}>
